master fiction metadata dictionary
==================================

A key to the meaning of columns in **masterficmeta.tsv.** This is a tab-separated tabular file in utf-8 encoding.

This is a list of 210,305 volumes that I believe to contain fiction. It has not been manually checked; it was produced by predictive modeling, and reflects estimated probabilities. If you have high standards for precision and recall, probably the best approach is to view this as a starting-place for further winnowing.
